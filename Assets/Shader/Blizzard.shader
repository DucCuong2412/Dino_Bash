...
void main ()
{
  ...
  highp vec2 tmpvar_6;
  tmpvar_6 = (_glesMultiTexCoord0.xy + tmpvar_5);
  tmpvar_3 = tmpvar_6;
  highp vec2 tmpvar_7;
  tmpvar_7 = (_glesMultiTexCoord0.xy + (tmpvar_5 * _LayerOffset));
  tmpvar_4 = tmpvar_7;
  tmpvar_2 = tmpvar_1;
...
void main ()
{
  lowp vec4 tmpvar_1;
  tmpvar_1 = ((vec4(pow (
    ((texture2D (_MainTex, xlv_TEXCOORD0).x * texture2D (_MainTex, xlv_TEXCOORD1).y) + 0.2)
  , 1.2)) * _Color) * _Opacity);
...
void main ()
{
  lowp vec4 tmpvar_1;
  tmpvar_1 = ((vec4(pow (
    ((texture (_MainTex, xlv_TEXCOORD0).x * texture (_MainTex, xlv_TEXCOORD1).y) + 0.2)
  , 1.2)) * _Color) * _Opacity);
...
void main ()
{
  ...
  highp vec2 tmpvar_7;
  tmpvar_7 = (_glesMultiTexCoord0.xy + tmpvar_6);
  tmpvar_3 = tmpvar_7;
  highp vec2 tmpvar_8;
  tmpvar_8 = (_glesMultiTexCoord0.xy + (tmpvar_6 * _LayerOffset));
  tmpvar_4 = tmpvar_8;
  tmpvar_2 = tmpvar_1;
  highp vec4 pos_9;
