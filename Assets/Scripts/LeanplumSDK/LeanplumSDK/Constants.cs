namespace LeanplumSDK
{
	public class Constants
	{
		...
		{
			internal const int ITER_COUNT = 1000;

			internal const int KEY_LENGTH = 256;

			internal const string SALT = "L3@nP1Vm";

			internal const string VECTOR = "__l3anplum__iv__";
		}
		...
		internal class Files
		{
			...
			internal static readonly int MAX_UPLOAD_BATCH_SIZES = 26214400;
		}
		...
		internal static bool isDevelopmentModeEnabled;

		internal static bool isInPermanentFailureState;

		internal static bool loggingEnabled;

		internal static bool isNoop;
