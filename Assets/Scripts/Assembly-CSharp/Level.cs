...
public class Level : MonoBase
{
    ...
    private float replayFactor
    {
        get
        {
            return 0;// Konfiguration.GameConfig.ReplayFactor;
        }
    }
    ...
    private float winlossFactor
    {
        get
        {
            return 0;//Konfiguration.GameConfig.Win_loss_influce;
        }
    }
    ...
    private int maxPlayCountInflunce
    {
        get
        {
            return 0;//Konfiguration.GameConfig.Win_loss_maxCount;
        }
    }
    ...
    private int replay_spread
    {
        get
        {
            return 0;//Konfiguration.GameConfig.Level_grind_spread;
        }
    }
    ...
    private float grind_factor
    {
        get
        {
            return 0;//onfiguration.GameConfig.Level_grind_factor;
        }
    }
    ...
    private float level_cutoff
    {
        get
        {
            return 0;// Config.var_cuttoff.Value;
        }
    }
    ...
    {
        return false;// Konfiguration.GameConfig.levelstart - 256f < pos_x && pos_x < (float)Instance.Config.levelwidth + 256f;
    }
}
