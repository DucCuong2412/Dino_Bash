...
namespace GooglePlayGames.Android
{
	internal class JavaUtil
	{
		...
		{
			//Discarded unreachable code: IL_0036, IL_004e
		...
		public static byte[] ConvertByteArray(AndroidJavaObject byteArrayObj)
		{
			...
			return AndroidJNIHelper.ConvertFromJNIArray<byte[]>(byteArrayObj.GetRawObject());
		}
		...
		public static Participant ConvertParticipant(AndroidJavaObject participant)
		{
			...
			{
			case 0:
				participantStatus = Participant.ParticipantStatus.NotInvitedYet;
				break;
			case 1:
				participantStatus = Participant.ParticipantStatus.Invited;
				break;
			case 2:
				participantStatus = Participant.ParticipantStatus.Joined;
				break;
			case 3:
				participantStatus = Participant.ParticipantStatus.Declined;
				break;
			case 4:
				participantStatus = Participant.ParticipantStatus.Left;
				break;
			case 5:
				participantStatus = Participant.ParticipantStatus.Finished;
				break;
			case 6:
				participantStatus = Participant.ParticipantStatus.Unresponsive;
				break;
			default:
				participantStatus = Participant.ParticipantStatus.Unknown;
				break;
			}
