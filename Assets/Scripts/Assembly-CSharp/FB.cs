...
public sealed class FB : ScriptableObject
{
	...
	//{
	//	public static void Pay(string product, string action = "purchaseitem", int quantity = 1, int? quantityMin = null, int? quantityMax = null, string requestId = null, string pricepointId = null, string testCurrency = null )
	//	{
	...
	public static string UserId
	{
		get
		{
			return string.Empty;// (facebook == null) ? string.Empty : facebook.UserId;
        }
	}
	...
	public static bool IsLoggedIn
	{
		get
		{
			return false;// facebook != null && facebook.IsLoggedIn;
		}
	}
