...
public class MapScreen : BaseScreen
{
    ...
    protected void Start()
    {
        ...
        else if ((Player.MaxLevelID == Konfiguration.LevelIndexForName("level_13") || (Player.MaxLevelID > Konfiguration.LevelIndexForName("level_13") && !RewardedFBLoginScreen.shown_in_session && !Player.Instance.PlayerData.userRecievedLoginReward && App.Instance.InternetConnectivity)))
        {
            StartCoroutine(ShowAfterLoading(delegate
            {
